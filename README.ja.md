...
- デバイス一覧で ⌥ キーを押すと完全な MAC アドレスと UUID を表示。離して再展開すると簡易表示に戻ります。（メニュー幅の縮小はシステムの制限により全メニューを閉じて再展開する必要があります）
...
> 2. **ダブルクリックせず**、Controlキーを押しながらアプリをクリックして **開く** を選ぶと「開く」ボタンが表示されます。
